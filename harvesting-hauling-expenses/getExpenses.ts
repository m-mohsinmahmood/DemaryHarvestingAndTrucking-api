...
export function getHarvestingExpenses(customer_id) {
   ...
   FROM (
    ...
    combine_equip + combine_fuel + tractor_equip + tractor_fuel + header_equipment + grain_cart_equipment + employee_lodging_estimate AS "total"
FROM (
    SELECT 
...
export function getHaulingExpenses(customer_id) {
    ...
    truck_equip,
          ...
          truck_equip + truck_fuel + truck_driver_lodging_estimate AS "total"
