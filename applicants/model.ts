export interface applicant {
  ...
  current_employement_period_start: string, 
  current_employement_period_end: string,
  current_supervisor_reference: string,
  current_supervisor_phone_number: string,
  current_contact_supervisor: string,
  previous_employer: string,
  previous_position_title: string,
  previous_description_of_role: string,
  previous_employement_period_start: string,
  previous_employement_period_end: string,
  previous_supervisor_reference: string,
  previous_supervisor_phone_number: string,
  previous_contact_supervisor: string,
