...
const httpTrigger: AzureFunction = async function (
  ...
  try {
    ...
    if (operation === 'verifyTicket') {
      ...
      if (ticket_update.destination != null && ticket_update.destination != '' && ticket_update.destination != 'null') {
        optionalReq = `${optionalReq},"destination" = '${ticket_update.destination}'`;
      }

      if (ticket_update.farmId != null && ticket_update.farmId != '' && ticket_update.farmId != 'null') {
        optionalReq = `${optionalReq},"farm_id" = '${ticket_update.farmId}'`;
      }

      if (ticket_update.NetWeight != null && ticket_update.NetWeight != '' && ticket_update.NetWeight != 'null') {
        optionalReq = `${optionalReq},"scale_ticket_weight" = '${+ticket_update.NetWeight}'`;
      }

      if (ticket_update.testWeight != null && ticket_update.testWeight != '' && ticket_update.testWeight != 'null') {
        optionalReq = `${optionalReq},"test_weight" = '${+ticket_update.testWeight}'`;
      }

      if (ticket_update.proteinContent != null && ticket_update.proteinContent != '' && ticket_update.proteinContent != 'null') {
        optionalReq = `${optionalReq},"protein_content" = '${+ticket_update.proteinContent}'`;
      }

      if (ticket_update.moistureContent != null && ticket_update.moistureContent != '' && ticket_update.moistureContent != 'null') {
